...
from ecommerce_business_store_singlevendor.utils.utils import verify_whitelisted_call, safe_decode, _close_the_doc
...
def setup_nginx(domain=None):
	try:
		...
		frappe.log_error(frappe.get_traceback(),'ecommerce_business_store_singlevendor.utils.domain_setup.setup_nginx')
