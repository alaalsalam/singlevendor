...
def get_data(filters):
	...
	for x in ret_data:
		...
		if 'stockone_integration' in frappe.get_installed_apps():
			stockone_id = frappe.db.get_value("Sales Invoice",x.against_reference,"stockone_id")
			if stockone_id:
				x.against_reference = stockone_id
