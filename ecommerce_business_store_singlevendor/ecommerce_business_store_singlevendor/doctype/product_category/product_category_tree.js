...
frappe.treeview_settings['Product Category'] = {
	...
	get_tree_nodes: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product_category.product_category.get_children",
	add_tree_node: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product_category.product_category.add_node",
			...
			click: function(node) {
				...
				const dialog = new frappe.ui.Dialog({
					...
					primary_action: function() {
						...
						return frappe.call({
							method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product_category.product_category.add_customer_withparent",
							args: {
