...
class ShoppingCart(Document):
	...
	def validate_item_price(self):
		...
		from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import validate_attributes_stock as _validate_stock
		free_items = []
		if self.items:
	...
	def validate_subtotal_discount_forfree_item(self):
		...
		from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.discounts.discounts import get_ordersubtotal_discount_forfree_item
