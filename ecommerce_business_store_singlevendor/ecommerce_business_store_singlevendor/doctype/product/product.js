...
{% include 'ecommerce_business_store_singlevendor/ecommerce_business_store_singlevendor/doctype/product/product_import.js' %}
frappe.provide("ecommerce_business_store_singlevendor.product");
...
frappe.ui.form.on('Product', {
    ...
    get_settings: function(frm,args) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.utils.setup.get_settings',
            args: args,
            async: false,
            callback: function(r) {
    ...
    set_product_brand_data(frm){
        frm.possible_val = [{  
            ...
            "search_fields":"name",
            "reference_method":"ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_models",
            "is_child": 1,
    ...
    filter_link_fields_data(frm){
        frm.set_query("product_attribute", "product_attributes", function (doc, cdt, cdn) {
            return {
                'query': 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_category_based_attributes',
                'filters': {
    ...
    get_all_brands(frm){
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_all_brands',
            args: {},
    ...
    hide_show_pre_order_section(frm){
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_order_settings',
            args: {},
            async:false,
            callback: function(d) {
                if(d.message){
    ...
    render_tags_html(frm){
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_all_tags',
            args: {},
            callback: function (data) {
                if(data.message){
    ...
    product_attribute_html: function (frm) {
        ...
        $(frm.get_field('product_attribute_html').wrapper).find('tbody .btn-danger').on('click', function () {
            ...
            frappe.confirm(__(msg), () => {
                if (id) {
                    frappe.call({
                        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_option',
                        args: {
                            name: id
                        },
                        callback: function (f) {
        ...
        $(frm.doc.product_attributes).each(function (k, v) {
            var attroptions = {}
            frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_parent_product_attribute_options',
    ...
    get_templates: function(frm) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_product_templates',
    ...
    choose_cross_selling: function(frm){
        frm.possible_val = [{
            ...
            "filters":"",
            "search_fields": "item",
            "reference_method": "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_returnpolicy_list",
            "is_child": 0,
    ...
    generate_attribute_image_html: function (frm, child_doctype, child_name, attribute_info) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.product.get_file_uploaded_imagelist',
            args: {
    ...
    image_upload: function (frm, link_doctype, link_name, parentfield, doctype, child_docname) {
        ...
        frappe.require("assets/ecommerce_business_store_singlevendor/js/fileupload.js", function () {
            setTimeout(function () {
    ...
    image_close_event(frm,imgDialog,child_docname){
        $(imgDialog.$wrapper).find('.img-close').on('click', function () {
            ...
            frappe.confirm(__("Do you want to delete the image?"), () => {
                let url = 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_current_img';
                if (child_docname){
                    url = 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.product.delete_current_attribute_img';
                }
                frappe.call({
                    method: url,
                    args: {
        ...
        $(imgDialog.$wrapper).find('#saveImages').click(function () {
            ...
            if (length > 0) {
                ...
                if (child_docname && items_list.length>0) {
                    frappe.call({
                        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.product.update_attribute_option_images',
                        args: {
                            dn: child_docname,
    ...
    video_upload: function (frm, link_doctype, link_name, parentfield, doctype, child_docname) {
        ...
        videoDialog.show();
        frappe.require("assets/ecommerce_business_store_singlevendor/js/videoupload.js", function () {
            setTimeout(function () {
                ...
                frappe.confirm(
                    ...
                    function () {
                        if (frm.all_attributes) {
                            frappe.call({
                                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.create_variant_combinations',
                                args: {
    ...
    add_product_attribute: function(frm){
        if(frm.is_new()){
            ...
            frm.possible_val = [{
                ...
                "reference_method": "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_category_attributes",
                "is_child": 0,
    ...
    get_all_attributes_and_options: function (frm) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_product_attributes_with_options',
            args: {
    ...
    edit_option_list: function (frm) {
        ...
        if (frm.attribute.product_attribute && frm.docname) {
            var html = `<input type="hidden" id="hdnAttributeOptionid"/>
                    ...
                    ` 
            frappe.call({
                method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_product_attribute_options",
                args: {
            ...
            if(this.frm.catalog_settings.enable_size_chart==0){
                cur_frm.doc.product_attributes.map(f => {
                    ...
                    <td style="text-align: center;">
                        <img src="/assets/ecommerce_business_store_singlevendor/images/section-icon.svg" 
...
var append_variant_html = Class.extend({
    ...
    update_row: function(wrapper, table, idx){
        ...
        let new_row = $(`
                <td style="width:5%;text-align: center;">
                    <img src="/assets/ecommerce_business_store_singlevendor/images/section-icon.svg" style="height:18px;cursor: all-scroll;position: relative;">
                    ${idx}
                </td>
                <td style="width:15%;display:none;">
                    <div class="product_attribute"></div>
    ...
    refresh_attribute_row: function(){
        ...
        let new_row = $(
            `<tr data-id="${cur_frm.doc.product_attributes[index].idx}" data-attr="${cur_frm.doc.product_attributes[index].attribute}" 
                    data-name="${cur_frm.doc.product_attributes[index].name}">
                <td style="width:5%;text-align: center;">
                    <img src="/assets/ecommerce_business_store_singlevendor/images/section-icon.svg" style="height:18px;
...
var SetupWizard = class SetupWizard extends frappe.ui.Slides {
    ...
    add_new_product() {
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.product.update_doc',
            args: {
                doc: this.values
            },
            callback: function(r) {
...
var UppyUploadComponent = Class.extend({
    ...
    upload_component: function(target, progress) {
        ...
        var uppy = Uppy.Core({
            ...
            .use(Uppy.XHRUpload, {
                endpoint: window.location.origin + '/api/method/ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.upload_galleryimg',
                method: 'post',
                formData: true,
                fieldname: 'file',
                headers: {
...
frappe.ui.form.on("Product Attribute Mapping", {
    ...
    before_product_attributes_remove: function (frm, cdt, cdn) {
        ...
        if (!items.__islocal) {
            frappe.call({
                method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.show_attribute_deletion_err",
                args: {
                    'row_id': cdn,
                    'item': frm.doc.name
                },
                ...
                always: function (r) {
                    if (r.message == "Failed") {
                        ...
                        frappe.call({
                            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_attribute_options',
                            args: {
                                dt: cdt,
                                dn: cdn
                            },
    ...
    edit_options: function (frm, cdt, cdn){
            ...
            frappe.call({
                ...
                callback: function (r) {
                    ...
                    if (r.message.length > 0) {
                        frappe.call({
                            method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.insert_attribute_template",
                            args: {
                                "attribute": frm.selected_doc.product_attribute,
        ...
        dialog.fields_dict.get_option_template.input.onclick = function () {
            ...
            dialog1.set_primary_action(__('Save'), function () {
                ...
                if (value) {
                    frappe.call({
                        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.select_attribute_template',
                        args: {
