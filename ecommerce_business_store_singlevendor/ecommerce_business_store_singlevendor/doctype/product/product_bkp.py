...
class Product(WebsiteGenerator):
	...
	def get_context(self, context):
		try:
			...
			from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_bestsellers,get_product_price,get_category_products,get_category_detail,get_enquiry_product_detail,get_customer_recently_viewed_products, get_product_other_info,get_parent_categorie
			product_brands = []
			product_attributes = []
			if self.status != 'Approved':
			...
			frappe.log_error(frappe.get_traceback(),'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.product.product.get_context')
	

	def get_contexttt(self, context):
		try:
			from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_bestsellers,get_product_price,get_category_products,get_category_detail,get_enquiry_product_detail,get_customer_recently_viewed_products, get_product_other_info
			product_brands = []
			product_attributes = []
	...
	def set_tax_rate(self, context,catalog_settings,orgprice):
		try:
			...
			frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.set_tax_rate")
	...
	def check_website_product_available(self, context):
		...
		if zipcode:
			...
			from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import check_user_location_delivery
		...
		if not self.current_availability and not self.next_available_at:
			...
			if not self.next_available_at:
				if restaurant.opening_hour:
					from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import check_next_seven_days
...
def remove_html_tags(text):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.product.events.remove_html_tags')

@frappe.whitelist(allow_guest=True)
def get_location_details(zipcode):
	city = state = country = None
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_geolocation
...
def get_related_option(addon,parent):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_related_option") 
...
def convert_product_image(image_name,size,productid,updated_column=None,updated_name=None):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.convert_product_image") 
...
def get_related_option_from_addon(add_on):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_related_option_from_addon") 
...
def get_relatedoption(addon):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_relatedoption") 
...
def get_product_attribute_options(attribute,product,attribute_id):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_product_attribute_options") 
...
def get_product_specification_attribute_options(attribute):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_product_specification_attribute_options") 
...
def insert_product_attribute_options(attribute,product,option,display_order,price_adjustment,weight_adjustment,image,pre_selected,attribute_color,product_title,parent_option=None,attribute_id = None,disable=None,available_datetime=None):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.insert_product_attribute_options") 
...
def update_product_attribute_options(attribute,product,option,display_order,price_adjustment,weight_adjustment,optionid,image,pre_selected,attribute_color,product_title,parent_option=None,attribute_id = None, disable=None,available_datetime=None):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.update_product_attribute_options") 
...
def get_all_brands():
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_all_brands") 
...
def get_all_category_list():    
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_all_category_list") 
...
def get_sub_category_list(category, condition=''):    
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_sub_category_list") 
...
def approve_products(names,status):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.approve_products") 
...
def save_as_template(names, selected_business):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.save_as_template") 
...
def delete_product_attribute_option(option):
	try:
		...
		if doc.get('image_list'):
			...
			from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import delete_attribute_image
			for im in images:
				delete_attribute_image(im)
		doc.delete()
		return {'status':'success'}
	except Exception as e:
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_product_attribute_option")
...
def delete_product_attribute_option_image(ref_doctype, file_url):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_product_attribute_option_image")
...
def check_menu_available_time():
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.check_menu_available_time")
...
def get_product_scroll(item, page_no, page_len):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_product_scroll")
...
def get_child_categories1(category):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api.get_child_categories')
@frappe.whitelist()
...
def get_recent_products(business = None):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_recent_products')
...
def insert_attribute_template(attribute,product_attr,message):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.insert_attribute_template')
...
def select_attribute_template(template_name,attribute,product,attribute_id):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.select_attribute_template')
...
def get_all_products_with_attributes(category=None, brand=None, item_name=None, active=None, featured=None, business=None):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_all_products_with_attributes") 
...
def get_product_attributes(name):	
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.get_product_attributes") 
...
def update_bulk_data(doctype,docname,fieldname,value):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.update_bulk_data") 
...
def upload_img():
	try:
		...
		frappe.log_error(frappe.get_traceback(),"ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.upload_img")
...
def product_detail_onscroll(productid, layout, domain=None):
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_bestsellers, get_product_other_info, get_customer_recently_viewed_products
	contexts = {}
	...
	for category in categories_list:
		...
		if check_product_box:
			...
			from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_parent_categorie
...
def insert_product_attribute_and_options(doc):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.insert_product_attribute_and_options") 
...
def upload_galleryimg():
	import base64
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.mobileapi import get_uploaded_file_content, update_doc
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import update_to_file
