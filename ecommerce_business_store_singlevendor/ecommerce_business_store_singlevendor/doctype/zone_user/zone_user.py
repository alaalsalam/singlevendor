...
from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers \
...
class ZoneUser(Document):
	...
	def validate_pwd(self):
		...
		from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order_settings.\
