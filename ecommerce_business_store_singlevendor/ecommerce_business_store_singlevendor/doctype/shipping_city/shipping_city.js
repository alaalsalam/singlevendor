...
frappe.ui.form.on('Shipping City', {
	...
	get_all_areas: function(frm){
        if(frm.doc.zipcode_range){
            frappe.call({
                        method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.shipping_city.shipping_city.get_areas_fromziprange",
                        args: {
...
function area_dialog(frm) {
    frm.possible_val = [{
        ...
        "search_fields": "area",
        "reference_method": "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.shipping_city.shipping_city.get_area_list",
        "is_child": 0,
