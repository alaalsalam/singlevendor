...
frappe.ui.form.on('Customers', {
    ...
    add_custom_buttons(frm){
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.get_order_settings',
            async: false,
            callback: function(d) {
    ...
    render_dashboard(frm){
        if (!frm.doc.__islocal) {
            frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.make_customers_dashboard',
                args: {
                    name: frm.doc.name
                },
                callback: function(r) {
    ...
    impersonate_customer:function(frm){
        ...
        if(confirm_result){
            ...
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.impersonate_customer',
            async: false,
            callback: function(d) {
    ...
    customer_order: function(frm) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.get_customer_orders',
            args: {
                customer_id: frm.doc.name
            },
            callback: function(r) {
	...
	build_html: function(frm){
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.get_all_roles',
            args: {},
