...
class Customers(NestedSet):
	...
	def on_update(self):
		try:
			...
			from ecommerce_business_store_singlevendor.utils.utils import other_exception
...
def update_address_data(first_name, email, phone,address_data=None):
	...
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.customer \
