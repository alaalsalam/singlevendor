...
frappe.treeview_settings['Customers'] = {
	...
	get_tree_nodes: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.get_children",
	add_tree_node: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.add_node",
	title:"Customers",
			...
			click: function(node) {
				...
				const dialog = new frappe.ui.Dialog({
					...
					primary_action: function() {
						dialog.hide();
						return frappe.call({
							method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.customers.customers.add_customer_withparent",
							args: {
