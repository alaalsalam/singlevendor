...
frappe.ui.form.on('Delivery Setting', {
	refresh: function(frm) {
       var category_lists = ""
         frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.delivery_setting.delivery_setting.check_category_exist_or_not',
            args: {},
            callback: function(r){
                if(r.message){
