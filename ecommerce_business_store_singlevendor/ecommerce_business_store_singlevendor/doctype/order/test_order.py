...
from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.test_product import make_products
...
def make_order(business, product, customer, shipping_charge, tax, attr, status, shipping_status, payment_status, subtotal_discount, delivery_discount):
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import validate_attributes_stock
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_order_discount, calculate_vendor_based_shipping_charges
	...
	from ecommerce_business_store_singlevendor.accounts.api import make_payment
