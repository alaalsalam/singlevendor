	...
	onload: function(listview) {
		if(frappe.session.user == 'Administrator') {
			listview.page.add_menu_item(__("Clear Records"), function() {
				listview.call_for_selected_items('ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.clear_selected_orders', {"status": "Completed"});
			});
		}
	}
};
