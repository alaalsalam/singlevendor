...
frappe.require("assets/ecommerce_business_store_singlevendor/css/select_list.css"); 
{% include 'ecommerce_business_store_singlevendor/ecommerce_business_store_singlevendor/doctype/order/order_common.js' %}
frappe.ui.form.on('Order', {
    refresh: function(frm) {
         if(frm.doc.shipping_method && frm.doc.customer){
           
            frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.checkout.get_cart_delivery_slots',
                args: {
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.check_order_settings',
            args: {},
            async: false,
            callback: function(d) {
        ...
        if (frm.doc.__unsaved && frm.check_order_settings.allow_admin_to_edit_order == 1){
            ...
            frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.check_installed_app',
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_linked_invoice',
        ...
        if (!frm.invoiceid) {
            frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_order_settings',
        ...
        if (frm.doc.docstatus == 1) {
            ...
            if(cur_frm.doc.is_shipment_bag_item==1){
                ...
                frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_shipment_bag_id',
            ...
            frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_customer_payments',
                args: {
                    'order': frm.doc.name
                },
                async: false,
        ...
        cur_frm.set_query("customer", function(frm) {
            return {
                query: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_customers",
                filters: {}
            }
        });
        cur_frm.set_query("business", "order_item", function(frm,cdt, cdn) {
            ...
            return {
                query: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_item_business",
                filters: {"item":d.item}
            }
        });
    ...
    make_payment_refund: function(frm){
        ...
        dialog.set_primary_action(__('Confirm'), function() {
            ...
            console.log(refund)
            frappe.call({
                method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.make_refund",
    ...
    make_invoice: function() {
        frappe.model.open_mapped_doc({
            method: "ecommerce_business_store_singlevendor.accounts.api.make_sales_invoice",
            frm: cur_frm
        })
    },
    make_payment: function() {
        frappe.model.open_mapped_doc({
            method: "ecommerce_business_store_singlevendor.accounts.api.make_payment",
            frm: cur_frm
        })
    },
    ...
    order_readyto_shipped: function(frm) {
        var method = 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api.order_readyto_shipped';
        frappe.call({
            method: method,
    ...
    create_return: function(frm) {
        ...
        frm.return_dialog.set_primary_action(__('Create Return'), function() {
            ...
            if (lists.length > 0 && allow_form == true) {
                frappe.call({
                    method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api.create_return_request',
                    args: {
    ...
    get_available_checkout_attributes: function(frm) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api.get_checkout_attributes',
            args: {
    ...
    edit_order_checkout_attributes: function(frm) { 
        ...
        dialog.set_primary_action(__('Save'), function() {
            ...
            if(attributes.length > 0) {
                frappe.call({
                    method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.update_order_checkout_attributes',
                    args: {
                        "order": frm.doc.name,
    ...
    order_shipping_options: function(frm) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_customer_loyaltypoints',
            ...
            callback: function(d) {
                if (d.message) {
                    ...
                    dialog.set_primary_action(__('Save'), function() {
                        ...
                        frappe.call({
                            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.update_order_totals',
                            args: {
                                "order": frm.doc.name,
...
frappe.ui.form.on("Order Item", {
    form_render: function(frm, cdt,cdn){
            ...
            if(d.item){
                ...
                frappe.call({
                            method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.order.order.get_attributes_combination",
                            args: {
                                product: d.item
                            },
                            callback: function(data) {
    ...
    attribute: function(frm, cdt, cdn){
        ...
        if(d.business && d.item && frm.doc.customer){
              frappe.call({
                method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.pricing.get_customer_product_pricing",
...
var change_status = function(docname, order_status, restaurant_status, driver_status) {
    frappe.call({
        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api.update_order_status',
        args: {
            name: docname,
...
var notifyDrivers = function(frm) {
    frappe.call({
        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api.assign_driver',
        args: {
            order: frm.doc.name
        },
        callback: function(data) {
