...
frappe.ui.form.on('Return Request', {
    ...
    filter_link_field_data(frm){
        frm.set_query("order_id", function() {
            return {
                'query': "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_eliglible_orders",
                "filters": {
        ...
        frm.fields_dict['items'].grid.get_field('order_item').get_query = function(doc, cdt, cdn) {
            return{
                'query': "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_order_items",
                "filters": {
    ...
    add_status_custom_btn_and_ship_rocket(frm){
		if (!frm.doc.__islocal){
			if(frm.doc.next_status_level){
                frappe.call({
                    method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_nextstatus",
                    args: {
    ...
    shipments: function(frm) {
		...
		let show_shipment = 0;
		frappe.call({
		    method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_returnorder_shipments',
		...
		if (show_shipment == 1 && allow == true && frm.doc.docstatus == 1) {
		    ...
		    frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_returnshipments',
    ...
    attribute_id:function(frm){
        if(frm.doc.attribute_id && frm.doc.order_id && frm.doc.product){
            frappe.call({
                method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_attributes_combination_html",
                args: {
    ...
    order_item(frm){
        if(frm.doc.order_item){
            frappe.call({
                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_order_item_info',
    ...
    select_shipment_method: function(frm) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.return_request.return_request.get_return_order_items',
