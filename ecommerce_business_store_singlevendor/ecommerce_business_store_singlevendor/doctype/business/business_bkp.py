...
from ecommerce_business_store_singlevendor.utils.setup import get_settings_value_from_domain, get_settings_from_domain
# from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import check_domain
from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.data_creation_report.data_creation_report import create_data_report, update_data_report
...
class Business(WebsiteGenerator, NestedSet):
	...
	# 		frappe.enqueue('ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.business.insert_default_data', business=self.name, business_name=self.restaurant_name)	
	...
	def get_context(self, context):
		...
		from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_vendor_based_products
		if not sort:
	...
	def get_restaurant_info(self, context, __order_type=None):
		from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api import get_restaurant_data,check_restaurant_asap_timings,get_common_timings
...
# 	except Exception:
# 		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.get_address") 
...
def validate_geo_location(self,address):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.validate_geo_location") 
...
def get_timeZone():
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.add_on.get_timeZone") 
...
def get_permission_query_conditions(user):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.get_permission_query_conditions") 
...
def get_print_formats():	
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.get_print_formats") 
...
def get_sorted_columns(sort_by):
	try:
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product_brand.get_sorted_columns") 
...
def enqueue_insert_business_data(business, business_name):
	frappe.enqueue('ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.business.insert_default_data', business=business, business_name=business_name)
...
def insert_default_data(business, business_name):
	...
	if not frappe.db.get_all("Slider",filters={"business":business}):
		...
		slider.web_image = '/assets/ecommerce_business_store_singlevendor/images/slider-web.jpg'
		slider.mobile_image = '/assets/ecommerce_business_store_singlevendor/images/slider-mobile.png'
		slider.mobile_app_image = '/assets/ecommerce_business_store_singlevendor/images/slider-mobile.png'
...
def insert_business_products1(selected_business,cur_business):
	frappe.enqueue('ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.business.insert_business_products', selected_business=selected_business, cur_business=cur_business)
...
def insert_business_products(selected_business, cur_business):
	try:
		...
		frappe.log_error(frappe.get_traceback(), 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.business.business.insert_business_products')
