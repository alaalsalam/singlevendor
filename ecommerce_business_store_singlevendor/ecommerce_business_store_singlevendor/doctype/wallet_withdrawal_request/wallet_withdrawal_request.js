                ...
                frappe.confirm('Are you sure want to confirm this withdrawal request?',
                    function(){
                        if(approve == 1){
                            approve = 0
                            frappe.call({
                                method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.wallet_withdrawal_request.wallet_withdrawal_request.update_requested_status',
