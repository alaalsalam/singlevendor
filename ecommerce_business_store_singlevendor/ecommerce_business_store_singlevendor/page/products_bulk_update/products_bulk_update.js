...
class BulkEdit {
    ...
    get_data() {
        ...
        let me = this;
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.page.products_bulk_update.products_bulk_update.get_all_products_with_attributes',
            args: {
        ...
        getEditor(colIndex, rowIndex, value, parent, column, row, data) {
            ...
            return {
                ...
                setValue(value) {
                    ...
                    $input.value = value;
                    frappe.call({
                        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.page.products_bulk_update.products_bulk_update.update_bulk_data',
                        args: {
                            'doctype': doctype,
                            'docname': docname,
...
function category_dialog1(data1) {
    ...
    categoryDialog.set_primary_action(__('Add'), function() {
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.update_product_categories1',
            args: {
                category1: cat_json,
                name: data1.name
            },
