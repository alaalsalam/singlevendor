...
from ecommerce_business_store_singlevendor.utils.utils import get_auth_token,get_customer_from_token,\
	other_exception
...
def get_all_website_settings_data():
	...
	if catalog_settings and media_settings and cart_settings and order_settings and app_settings:
		...
		if app_settings:
			...
			website_logo = app_settings.website_logo
			login_image = app_settings.login_image
		from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.category import get_parent_categories
		res_data={
...
def validate_page_section(page_content,seller_classify):
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.product import get_list_product_details	
...
def update_recently_viewed_products(guest_id, customer_id):
	...
	for x in recently_viewed_products:
		frappe.enqueue("ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.api.\
