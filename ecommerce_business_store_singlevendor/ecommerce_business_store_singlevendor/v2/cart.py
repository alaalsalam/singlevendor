...
from ecommerce_business_store_singlevendor.utils.utils import other_exception,get_customer_from_token
...
def get_cart_items(customer_id = None):
	try:
		if customer_id:
			...
			customer = get_customer_from_token()
		if customer:
			from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.product import get_bought_together
