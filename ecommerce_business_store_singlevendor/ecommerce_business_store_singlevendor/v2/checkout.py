...
from ecommerce_business_store_singlevendor.utils.utils import get_today_date
...
def get_sh_charges_by_sh_method(SRM_info,shipping_method,shipping_addr,shopping_cart):
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.v2.orders import\
...
def get_validate_coupons_cart_items(coupon_code, subtotal, customer_id, cart_items,shipping_charges,
								discount_type,total_weight, shipping_method, payment_method):
	from ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.discounts.discounts\
