...
def get_shipping_methods(doctype,txt,searchfield,start,page_len,filters):
	try:	
		...
		frappe.log_error(frappe.get_traceback(), "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.report.daily_sales_report.daily_sales_report.get_shipping_methods") 
