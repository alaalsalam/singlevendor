...
function get_attribute_videos(optionId, doctype){
    if(optionId){
     frappe.call({
        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_attribute_option_videos',
        args: {
            option_id: optionId
        },
        callback: function(data) {
...
function DeleteAttributeOption(optionId) {
    if(cur_frm.doc.variant_combination.length > 0){
        ...
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_attribute_option_alert',
            args: {
                option: optionId
            },
            callback: function(data) {
...
function deleteAttr(optionId){
    ...
    if (result) {
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_product_attribute_option',
            args: {
                option: optionId
            },
            callback: function(data) {
