frappe.provide("ecommerce_business_store_singlevendor");
frappe.provide("ecommerce_business_store_singlevendor.utils");

$.extend(ecommerce_business_store_singlevendor, {
	sample: function(company) {
	console.log("-")
	}
})
$.extend(ecommerce_business_store_singlevendor.utils, {
