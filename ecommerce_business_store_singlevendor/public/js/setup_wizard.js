frappe.provide("ecommerce_business_store_singlevendor.setup");
...
frappe.setup.on("before_load", function () {
	ecommerce_business_store_singlevendor.setup.slides_settings.map(frappe.setup.add_slide);
});

ecommerce_business_store_singlevendor.setup.slides_settings = [
	{
