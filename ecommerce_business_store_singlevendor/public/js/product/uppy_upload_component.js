var UppyUploadComponent = Class.extend({
    ...
    get_image_album: function(dt, dn) {
        let me = this;
        frappe.call({
            method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_doc_images',
            args: {
                dt: dt,
                dn: dn
            },
    ...
    upload_component: function(target, progress) {
        ...
        var uppy = Uppy.Core({
            ...
            .use(Uppy.XHRUpload, {
                endpoint: window.location.origin + '/api/method/ecommerce_business_store_singlevendor.cms.doctype.web_page_builder.web_page_builder.upload_img',
                method: 'post',
                formData: true,
                fieldname: 'file',
                headers: {
