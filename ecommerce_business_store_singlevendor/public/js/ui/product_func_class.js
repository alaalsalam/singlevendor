frappe.provide("ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor");
...
function pick_color(e){
 ...
 function choose_display_types(e){
    ...
    if(control=="Radio Button List"){
        default_control ='<img src="/assets/ecommerce_business_store_singlevendor/images/radio-button.png" style="width:125px" />'
    }
    if(control=="Checkbox List"){
        default_control ='<img src="/assets/ecommerce_business_store_singlevendor/images/checkbox.png" style="width:125px"/>'
    }
    if(control=="Dropdown List"){
        default_control ='<img src="/assets/ecommerce_business_store_singlevendor/images/list.png" style="width:125px"/>'
    }
    if(control=="Color Boxes"){
        default_control ='<img src="/assets/ecommerce_business_store_singlevendor/images/color-boxes.png" style="width:125px"/>'
    }
    if(control=="Text Box"){
        default_control ='<img src="/assets/ecommerce_business_store_singlevendor/images/text-box.png" style="width:260px"/>'
    }
    if(control=="Table"){
        default_control ='<img src="/assets/ecommerce_business_store_singlevendor/images/table.png" style="width:260px;"/>'
    }
    if(control=="Multi Line Text"){
        default_control ='<img src="/assets/ecommerce_business_store_singlevendor/images/multiline.png" style="width:260px"/>'
    }
    ...
    dialog.fields_dict["controltype_html"].$wrapper.find('input[name="control_type"]').on("click", function(){
        ...
        if(val=="Radio Button List"){
            html ='<img src="/assets/ecommerce_business_store_singlevendor/images/radio-button.png" style="width:125px"/>'
        }
        if(val=="Checkbox List"){
            html ='<img src="/assets/ecommerce_business_store_singlevendor/images/checkbox.png" style="width:125px"/>'
        }
        if(val=="Dropdown List"){
            html ='<img src="/assets/ecommerce_business_store_singlevendor/images/list.png" style="width:125px"/>'
        }
        if(val=="Color Boxes"){
            html ='<img src="/assets/ecommerce_business_store_singlevendor/images/color-boxes.png" style="width:125px"/>'
        }
        if(val=="Text Box"){
            html ='<img src="/assets/ecommerce_business_store_singlevendor/images/text-box.png" style="width:260px"/>'
        }
        if(val=="Table"){
            html ='<img src="/assets/ecommerce_business_store_singlevendor/images/table.png" style="width:260px"/>'
        }
        if(val=="Multi Line Text"){
            html ='<img src="/assets/ecommerce_business_store_singlevendor/images/multiline.png" style="width:260px"/>'
        }
...
function update_attroption(e){
    ...
    var optionhtml = '<div class="form-group option-group" style="margin-bottom: 0px;"><div class="control-input-wrapper"> <div class="control-input form-control table-multiselect" id="table-multiselect">'
    ...
    $(cur_frm.doc.attribute_options).each(function(i, f){
       if(objIndex==i && f.attribute == cur_frm.doc.product_attributes[index].product_attribute && f.attribute_id == cur_frm.doc.product_attributes[index].name){
        ...
        optionhtml += '<a class="btn '+btn_cls+' btn-xs btn-link-to-form" data-parentidx="'+parentindex+'" data-id="'+f.option_value+'" data-attribute="'+cur_frm.doc.product_attributes[index]["product_attribute"]+'" data-index="'+index+'" data-display_order="'+comb_index+'" data-option_name="'+f.name+'" data-is_pre_selected="'+cur_frm.doc.attribute_options[objIndex].is_pre_selected+'" data-product_title="'+f.product_title+'"  data-disable="'+f.disable+'" data-parent-control-type="'+cur_frm.doc.product_attributes[index]["control_type"]+'" ondblclick="update_attroption($(this))"><img src="/assets/ecommerce_business_store_singlevendor/images/section-icon.svg" style="height:10px;cursor: all-scroll;position: relative;">'+f.option_value+'</a>'
...
function save_attribute_and_options(){
    if(cur_frm.attribute_items){
        ...
        frappe.call({
        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.insert_product_attribute_and_options',
            ...
            if (attributeId1) {
                if (attributeId1) {
                    ...
                    video_dialog.set_primary_action(__('Add'), function () {
                        ...
                        frappe.call({
                            method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.insert_attribute_option_video",
                            args: {
      ...
      let input4 = frappe.ui.form.make_control({
        ...
        new_row.find('.btn-danger').click(function() {
            ...
            frappe.warn("Do you want to delete the following combination?", conf_html,function () {
                frappe.call({
                    method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_combination',
                    args: {"dt":dt, "dn":dn},
                    async: false,
                    callback: function(r) {
                        $(obj).each(function(k, v) {
...
function edit_combination_details(e){
    ...
    if(!cur_frm.doc.__islocal){
        new ecommerce_business_store_singlevendor.MakeVarientCombinationDialog({
            frm: cur_frm,
...
ecommerce_business_store_singlevendor.MakeVarientCombinationDialog = Class.extend({
    init: function(opts) {
        this.frm = opts.frm;
        ...
        let table = $(`<table class="table table-bordered">
            ...
            data.map(f => {
                ...
                let input = frappe.ui.form.make_control({
                    ...
                    "get_query": function() { 
                        return {
                            query: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.get_role_list",
                            filters: {}
                        };
                    },
...
function DeleteAttributeOptionVideo(video_id,optionId){
    frappe.call({
        method: 'ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product.product.delete_product_attribute_option_video',
        args: {
            name:video_id
        },
        callback: function (r) {
