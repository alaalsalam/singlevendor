	...
	return new Promise((resolve) => {
			if (this.qty_fieldname) {
				...
				if(this.target.doctype="Product Mapping Tool Item"){
						frappe.call({
							method: "ecommerce_business_store_singlevendor.ecommerce_business_store_singlevendor.doctype.product_mapping_tool.product_mapping_tool.get_product_detail",
							type: "GET",
							args: {"product": value},
							callback: function (r) {
